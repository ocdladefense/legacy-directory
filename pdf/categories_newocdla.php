...
switch ( $_GET["category"] ) {
	case "contact_type": $query = 'SELECT DISTINCT note_description FROM member_interests WHERE note_type="Contact Type" ORDER BY note_description'; $link = "quick_search_newocdla.php?category=contact_type&contact_type=";break;
		
	case "aoi": $query = 'SELECT DISTINCT note_description FROM member_interests WHERE note_type="Area of Interest" ORDER BY note_description'; $link = "quick_search_newocdla.php?category=aoi&aoi=";break;
