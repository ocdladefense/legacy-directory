...
$query = 'SELECT members.id, CONCAT(name_last,", ",name_first) AS full_name, name_company, address_city, address_state, address_zip, contact_types, interests, bar_number, suffix
